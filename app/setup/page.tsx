...
const steps = [
  ...
  { icon: KeyRound, title: '5. ដាក់ Secrets ក្នុង Cloudflare', detail: 'ដាក់ GOOGLE_SERVICE_ACCOUNT_EMAIL, GOOGLE_PRIVATE_KEY, TELEGRAM_BOT_TOKEN, TELEGRAM_CHAT_ID និង GOOGLE_CLIENT_ID ក្នុង Workers → Settings → Variables and Secrets។ ជ្រើស Encrypt សម្រាប់ Private Key និង Bot Token។' },
  { icon: CheckCircle2, title: '6. ការពារ Dashboard និងបើកប្រើ', detail: 'បង្កើត Google OAuth Client ប្រភេទ Web application ហើយដាក់ URL គេហទំព័រក្នុង Authorized JavaScript origins។ ចូល /dashboard តាម Sign in with Google ដោយប្រើ komchay8@gmail.com។ Form /request អាចប្រើដោយមិន Login។' },
];
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
        ...
        <div className="mt-6 rounded-2xl border bg-white p-5"><h2 className="font-bold">Secrets ដែលមិនត្រូវដាក់ក្នុង GitHub</h2><div className="mt-3 grid gap-2 font-mono text-xs text-slate-600"><code>GOOGLE_PRIVATE_KEY</code><code>TELEGRAM_BOT_TOKEN</code></div></div>
      </div>
    </main>
  );
}
