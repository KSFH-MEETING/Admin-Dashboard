...
function route(file) { return url(compile(file).replaceAll("'@/lib/server/admin-auth'", JSON.stringify(auth)).replaceAll("'@/lib/server/google-identity'", JSON.stringify(identity)).replaceAll("'@/lib/server/dashboard-users'", JSON.stringify(store))); }
